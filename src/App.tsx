...
function App() {
  ...
  return  <>
      <section className=" min-h-screen  pt-14 bg-slate-950  ">
        ...
        <div className=" grid grid-cols-6 gap-y-5 py-5 min-h- container mx-24    ">
          <div className="col-span-4  mx-10   rounded-full">
            <input
              ...
              type="text" placeholder="Type here" className="input  bg-slate-900 text-slate-300 font-medium  placeholder:text-slate-300 w-full rounded-full " />
          </div>
{
  weatherData? <MainWea data={weatherData} /> : <div className="mx-20 w-1/2 flex my-10 justify-center col-span-4"><span className="loader ml-24"></span>
        </div>
}
